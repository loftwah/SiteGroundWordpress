...
function nt_single_property($post_id, $compare = false)
{
	...
	$has_features = (count($all_features) > 0)?true:false;
    ?>
...
<ul class="meta-box-list">
	<li><?php echo 'ID: <b>'.get_the_ID().'</b>'; ?><span class="tooltip"><?php _e('ID', 'theme_front'); ?></span></li><?php if($area): ?><li><span class="lt-icon flaticon-display6"></span> <?php echo nt_area_format($area); ?> <?php echo nt_get_option('property', 'area'); ?><span class="tooltip"><?php _e('Size', 'theme_front'); ?></span></li><?php endif; ?><?php if($bed): ?><li><i class="lt-icon flaticon-person1 big"></i> <?php echo floatval($bed); ?><span class="tooltip"><?php echo _n( 'Bedroom', 'Bedrooms', $bed, 'theme_front' ); ?></span></li><?php endif; ?><?php if($bath): ?><li><span class="lt-icon flaticon-shower5"></span> <?php echo floatval($bath); ?><span class="tooltip"><?php echo _n( 'Bathroom', 'Bathrooms', $bath, 'theme_front' ); ?></span></li><?php endif; ?><?php if($garage): ?><li><i class="lt-icon flaticon-car95"></i> <?php echo floatval($garage); ?><span class="tooltip"><?php echo _n( 'Parking', 'Parking', $garage, 'theme_front' ); ?></span></li><?php endif; ?>
</ul>
...
<div class="vc_tta-tabs wpb_content_element property-features-tabs" data-interval="0">
	...
	<ul class="vc_tta-tabs-list">
		...
		<?php if ($has_features): ?><li class="tab-features"><a href="#tab-features" data-vc-tabs data-vc-container=".vc_tta"><?php _e('FEATURES', 'theme_front');?></a></li><?php endif;?>
...
if (isset($agents) && $agents[0] != ''):
	...
	<?php elseif (isset($user_agent) && $user_agent):
        ...
        if (!$user_agent_display_name) {
            $user_agent_display_name = get_user_meta($user_agent, 'nickname', true);
        }
...
<?php if (!$compare && nt_get_option('property', 'single_share', 'on') == 'on') {
        get_template_part('section/section', 'share');
    }
    ?>

<?php if (!$compare && false) {
        get_template_part('section/section', 'related-property');
    }
    ?>
